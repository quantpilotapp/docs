...
Simple and naive solutions can answer basic questions, but are not able to forecast, find similarities, or do LLM analysis without necessary context.

Users want query the agent to:

* understand fan base sentiment
